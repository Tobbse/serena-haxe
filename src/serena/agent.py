...
class SerenaAgent:
    ...
    def reset_language_server_manager(self) -> None:
        ...
        ls_specific_settings = {**self.serena_config.ls_specific_settings, **active_project.project_config.ls_specific_settings}
        active_project.create_language_server_manager(
